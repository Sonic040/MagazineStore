...
namespace MagazineSrore.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cid,Cname,Imagepath,ImageFile")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Cid,Cname,Imagepath,ImageFile")] Category category)
        {
            if (id != category.Cid)
            {
                return NotFound();
